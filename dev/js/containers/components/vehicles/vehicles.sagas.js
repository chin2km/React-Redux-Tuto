...
export  default function* VehiclesSagas() {
  yield [
    takeLatest(LandingActions.FETCH_VEHICLES_BY_PAGE, LandingSagas.fetchDataByPageSaga),
    takeEvery(DetailActions.FETCH_VEHICLE_BY_ID, DetailsSagas.fetchDataByIdSaga)
  ]
}